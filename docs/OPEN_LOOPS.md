...
| L13 | ตอน deploy ตรวจว่า proxy (Coolify/Traefik) **append** `x-forwarded-for` และ app เข้าถึงตรงโดยไม่ผ่าน proxy ไม่ได้ — ไม่งั้นค่าท้ายปลอมได้ rate limit เลี่ยงได้ | human | P2 | Lab 08 | D9 · L11 · `docs/handoffs/05-opencode-to-claude-l11.md` |
