...
| D15 | Palette (Lab 04) | **B Teal สดชื่น** · `--bg #F3FAF8` · `--card #FFFFFF` · `--text #12302C` (13.36:1) · `--muted #44605B` (6.46:1) · `--accent #0F766E` (5.17:1 บนพื้น · ปุ่มตัวอักษรขาว 5.47:1) · ไฮไลต์ `#FACC15` (ตกแต่งเท่านั้น ห้ามใช้เป็นสีตัวอักษร) · `--border #CFE7E2` · แก้ที่ `:root` ใน `BaseLayout.astro` จุดเดียว | PROFILE `## Tone` = สดใส เป็นกันเอง แต่ไม่ได้ระบุสี · contrast ผ่าน WCAG AA ทุกคู่ | Frontend เสนอ 3 ชุด · เจ้าของเลือก B (2026-09-25) |
...
| ~~#9–#12~~ | title ตามตัวอย่างในคอร์ส (ทาง B) | เลข D ไม่ตรง · ซ้ำกับ #2 / #4 / #7 | gh | **ลบแล้ว** (เจ้าของสั่ง) · เลข 9–12 จะไม่ถูกใช้ซ้ำ |
